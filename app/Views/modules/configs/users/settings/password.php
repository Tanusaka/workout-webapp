...
<div id="user_passwordsettings" class="course-section-wrapper">

    <div class="card-body border-0 pb-0">
        <form id="form-changepassword" action="" class="col-md-12 mb-6">
             
             <div class="profile-txtgroup mb-3">
                 <p class="text-truncate fw-sb fs-12 fc-dark">Change Password</p>
             </div>
