    ...
    <div id="kt_course_content_header">
        <div class="card-header border-0 p-0 mb-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span id="kt_course_content_tagline" class="text-muted mt-1 fw-semibold fs-7">14 sections • 105 lectures • 4h 50m total length</span>
            </h3>
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" data-bs-original-title="Click to add a section" data-kt-initialized="1">
                <a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_addsection">
