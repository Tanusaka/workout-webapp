...
<div class="modal fade" id="editSettingsModal" tabindex="-1" aria-labelledby="editSettingsModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg modal-fixed-height-dialog">
        <div class="modal-content modal-fixed-height-content">
            ...
            <div class="modal-body modal-fixed-height-body">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content tab-content-scroll" id="tab_content">
