...
<div id="modal_editcontent" class="modal fade" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div id="modal_body_viewcontent" class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <!--begin::Form-->
                <form class="w-100 mw-600px pt-15 pb-10" novalidate="novalidate" id="kt_update_content_form" action="">
                    <!--begin::Step 1-->
                    <div class="current" data-kt-stepper-element="content">
                        ...
                        <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <!--begin::Title-->
                                <h2 class="fw-bold d-flex align-items-center text-dark">Edit Lesson
                            ...
                            <div class="inp-hidden">
                                <!--begin::Input-->
                                <input type="hidden" class="inp-hidden-txt" name="content_id" placeholder="" value="" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                    ...
                    <div class="d-flex flex-end pt-10">
                        <!--begin::Wrapper-->
                        <div>
                            <button type="submit" id="kt_update_content_submit" class="btn btn-lg btn-primary">
